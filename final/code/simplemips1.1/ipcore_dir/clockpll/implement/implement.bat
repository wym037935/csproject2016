...
xst -ifn xst.scr
move clockpll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clockpll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockpll_exdes.ucf clockpll_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm clockpll_exdes -w routed.ncd routed.v
cd ..
